 ...
 */
async function openSpraySheet(ctx, cycleId, watched = null) {
  // UX-27: until the trial round is signed off a spray is only started with a
  // supervisor standing there, and who that was goes on the record too.
  sprayWatch = watched;
